def calculator():
    ...
    Features:
    - Handles invalid input gracefully by prompting the user to enter valid choices or numeric values.
    ...
    Raises:
    - ValueError: If the user inputs non-numeric values where numeric input is expected.
    """
    while True:
